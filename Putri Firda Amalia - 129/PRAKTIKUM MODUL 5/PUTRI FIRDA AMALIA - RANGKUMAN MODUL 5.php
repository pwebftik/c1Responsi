...
echo $x / $y . "<br>";
echo "<br>";
echo strlen("BELAJAR")."<br>";//panjang string = 7
echo str_word_count("BELAJAR PEMPROGRAMAN WEB")."<br>";//jumlah kalimat = 3
echo strrev("TUGAS PRAKTIKUM")."<br>";//membalikkan string
echo strpos("GOOD MORNING", "MORNING")."<br>"."<br>";//posisi string yang dicari berada kalimat ke 2
